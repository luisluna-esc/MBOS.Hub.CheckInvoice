...
public class ReportsController : ControllerBase
{
    ...
    // El modelo de permisos simplificado (visita/trabajo) no distingue por rol, así que
    // el reporte financiero de toda la organización necesita esta restricción explícita
    // además de la política — sin esto, cualquier rol con "visita" (incluido Pastor) podría
    // llamar el endpoint directamente aunque no vea el menú.
    ...
    {
        var pdfBytes = await _reportService.GenerateFinancialDashboardPdf();
        return File(pdfBytes, "application/pdf", "reporte-financiero.pdf");
    }
